...
// REMOVE faShoppingCart AND faEye from this import as they are not used in this file.
// faCheck IS USED in ProductCard, so keep it.
...
          alt={name} 
          loading='lazy'
          className="w-full h-auto object-cover mt-[-70px]" // Corrected img_path to load correctly
        />
        
        {/* Quick Action Overlay - This div is empty, so it serves no visible purpose.
           If you meant to have an overlay with content, you need to add it here.
           Otherwise, it's harmless but could be removed if you prefer. */}
